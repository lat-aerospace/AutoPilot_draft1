# ======================================================================
# AcConstants.fpp — Project overrides
# This file replaces the framework default. All constants must be present.
# ======================================================================
...
@ Used to drive rate groups (OVERRIDE: default is 3, we need 4 for SITL)
